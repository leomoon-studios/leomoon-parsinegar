...
LeoMoon ParsiNegar begins from the tested host-independent components bundled with Omarchy ParsiNegar Express. The desktop project copies pinned artifacts rather than making the plugin a build or runtime dependency.
...
| `assets/fonts/MaterialSymbolsRounded.ttf` | Material Symbols Rounded commit `40a7a292a79d9394157e1ea24f83d52d5e17c556`, subset to sixteen documented glyphs | `c741278830e2210e57d0a63c85e21a03ad348c05f5854974b8a7a2bbe7331110` |

The fonts under `assets/fonts/system/` are first-party LeoMoon ParsiNegar compatibility fonts distributed as an optional system-wide installer component. They are not application resources.

The complete supplied notices and library documentation are retained below `vendor/js-bidi/`, `vendor/js-parsi-reshaper/`, `vendor/typr/`, and `assets/fonts/`. The Material Symbols subset contains U+E15A, U+E166, U+E247, U+E248, U+E2C4, U+E312, U+E518, U+E51C, U+E5C4, U+E5C8, U+E5D5, U+E873, U+E87D, U+E8B8, U+E8FD, and U+F10B; its unchanged full-font input had SHA-256 `f1472f172c0fc4a922be22972e4752ccc54fe795ed82564ab6f6b097782f2dbc`. The `tests/CheckLicenses.cmake` inventory prevents a known artifact or required notice from being omitted accidentally.
