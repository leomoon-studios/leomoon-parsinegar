...
var InterfaceStrings = (function () {
  ...
  var values = {
    en: {
      ...
      "tools.title": "Text tools", "tools.intro": "Enabled tools update the source text when you convert, then the updated text is converted and copied.", "tools.undo": "Undo text-tool edit", "tools.undoStatus": "Text-tool edit undone.", "tools.appliedStatus": "Enabled text tools were applied to the source.",
    ...
    fa: {
      ...
      "tools.title": "ابزارهای متن", "tools.intro": "ابزارهای فعال هنگام تبدیل، متن منبع را تغییر می‌دهند؛ سپس متنِ به‌روزشده تبدیل و کپی می‌شود.", "tools.undo": "واگردانی ویرایش ابزار متن", "tools.undoStatus": "ویرایش ابزار متن واگردانی شد.", "tools.appliedStatus": "ابزارهای فعال روی متن منبع اعمال شدند.",
