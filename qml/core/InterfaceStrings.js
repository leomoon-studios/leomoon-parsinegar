...
var InterfaceStrings = (function () {
  ...
  var values = {
    en: {
      ...
      "settings.interfaceLanguageDescription": "Choose the language used by this interface.", "language.english": "English", "language.persian": "پارسی", "settings.appearance": "APPEARANCE", "settings.darkTheme": "Use dark theme", "settings.darkThemeDescription": "Use the dark color palette for this application.",
    ...
    fa: {
      ...
      "settings.interfaceLanguageDescription": "زبان نمایش متن‌ها و کنترل‌های این افزونه را انتخاب کنید.", "language.english": "English", "language.persian": "پارسی", "settings.appearance": "ظاهر", "settings.darkTheme": "استفاده از پوستهٔ تیره", "settings.darkThemeDescription": "از رنگ‌بندی تیره برای این برنامه استفاده می‌کند.",
