...
var InterfaceStrings = (function () {
  ...
  var values = {
    en: {
      ...
      "export.missingGlyphTitle": "Missing glyphs", "export.missingGlyphConfirm": "This font does not contain every required glyph. Save using its missing-glyph outlines anyway?",
    ...
    fa: {
      ...
      "export.missingGlyphTitle": "گلیف‌های ناموجود", "export.missingGlyphConfirm": "این فونت همهٔ گلیف‌های لازم را ندارد. فایل با نماد گلیف‌های ناموجود ذخیره شود؟",
