...
TestCase {
    ...
    function test_windowResizesWithoutClipping() {
        ...
        var donateButton = findChild(applicationWindow, "donateButton")
        ...
        verify(donateButton.mapToItem(applicationWindow.contentItem, 0, 0).x + donateButton.width
            <= applicationWindow.contentItem.width - AppTheme.spacingLarge + 0.5)
    ...
    function test_reusableControlsAndThemeSwitch() {
        ...
        compare(donateButton.glyph, AppTheme.iconDonate)
        compare(donateButton.contentItem.color, AppTheme.donationHeart)
        compare(donateButton.toolTip, controller.uiText("button.donate"))
        compare(donateButton.donationUrl.toString(), "https://www.paypal.com/donate?hosted_button_id=TYDVJHYA9VYKN")
        ...
        compare(donateButton.width, helpButton.width)
        verify(helpButton.x < donateButton.x)
