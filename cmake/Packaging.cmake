...
elseif(APPLE)
    ...
    set(CPACK_DEBIAN_SYSTEMFONTS_PACKAGE_ARCHITECTURE all)
...
if(WIN32)
    if(NOT DEFINED PARSINEGAR_WINDOWS_RELEASE_ARCH)
        if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(ARM64|arm64|aarch64)$")
            set(PARSINEGAR_WINDOWS_RELEASE_ARCH arm64)
        else()
            set(PARSINEGAR_WINDOWS_RELEASE_ARCH x64)
        endif()
    endif()
    if(PARSINEGAR_WINDOWS_RELEASE_ARCH STREQUAL "arm64")
        set(PARSINEGAR_WINDOWS_INNO_ARCHITECTURE arm64compatible)
    elseif(PARSINEGAR_WINDOWS_RELEASE_ARCH STREQUAL "x64")
        set(PARSINEGAR_WINDOWS_INNO_ARCHITECTURE x64compatible)
    else()
        message(FATAL_ERROR "Unsupported Windows release architecture: ${PARSINEGAR_WINDOWS_RELEASE_ARCH}")
    endif()
